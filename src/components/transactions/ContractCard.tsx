...
export const ContractCard: React.FC<ContractCardProps> = ({
  ...
  if (variant === "summary") {
    return (
      <div
        className={`bg-background-secondary border border-text-light rounded-md p-4 ${className}`}
      >
        <div className="flex justify-between items-start mb-2">
          ...
          <div className="text-right">
            ...
            <p className="text-xs font-semibold text-text-secondary">KRWS</p>
          </div>
        </div>
  ...
  return (
    <div
      className={`bg-background-secondary border border-text-light rounded-md ${className}`}
    >
        ...
        <div className="space-y-3 pt-2">
          ...
          {contract.fee !== undefined && (
            <div className="flex justify-between text-xs">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-text-secondary">KRWS</span>
              </div>
            </div>
          )}
          ...
          {contract.landlordAccount && (
            <div className="flex justify-between text-xs">
              ...
              <span className="text-text-secondary">
                {contract.landlordAccount.bank},
                {contract.landlordAccount.number},
                {contract.landlordAccount.name}
              </span>
            </div>
          )}
          ...
          {contract.tenantName && (
            <div className="flex justify-between text-xs">
              ...
              <span className="text-text-secondary">{contract.tenantName}</span>
            </div>
          )}
