    ...
    <div className="min-h-screen bg-white flex flex-col px-6">
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <div className="bg-background-secondary rounded-lg p-4 w-full max-w-sm mb-8">
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium text-text-primary">SP-2025-0001</span>
            </div>
            <div className="flex justify-between">
        ...
        <div className="w-full max-w-sm space-y-3">
          ...
          <button 
            onClick={() => {}}
            className="w-full py-3 px-4 rounded-lg border border-primary text-primary font-medium hover:bg-primary/5 transition-colors"
          >
            계약 상세 보기
          </button>
        </div>
